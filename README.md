...
2.  **Engenharia de Valor (Amenities):**
    ...
    * *Insight:* O conforto térmico é mais valorizado pelo hóspede do que o lazer da piscina neste mercado.

---

## 📸 Screenshots

### Matriz de Oportunidade (Quadrantes Mágicos)
Identificação visual dos bairros "Oportunidade" (Canto Superior Esquerdo).
![Scatter Plot](assets/scatter_plot.png)
*(Certifique-se de salvar a imagem na pasta assets com esse nome ou ajuste o link)*
